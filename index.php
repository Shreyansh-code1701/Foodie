                                    ...
                                    <div class="entry-inner">
                                        ...
                                        <div class="content-wrapper col-md-12 col-sm-12 col-xs-12 " style="border: 1px dotted #f8a631;">
                                            <h3 class="entry-name" style="text-transform: capitalize;"><a href="product.php?stid=<?php echo $row[8]; ?>">
                                                    <font style="text-transform: capitalize;"><?php echo $row[9]; ?></font>
                                                </a></h3>
                                            ...
                                            <div class="col-md-12 ">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        // $rve=  mysql_query("select count(productid) from reviewproduct where productid='$row[8]'");
                                                        // $rv=  mysql_fetch_array($rve);
                                                        {
                                                        ?>
            ...
            <div class="hs-content">
                <div class="ht-masonry-layout ht-lightbox-gallery container" data-grid-size="20%" data-child="a">
                    <div class="entry" style="width: 20%">
                        <a href="images/gallery/1.jpg" class="overlay" ></a><i class="fa fa-arrows-alt"></i></a>
                        <img src="images/gallery/1.jpg" alt="">
                    </div>
                    <div class="entry" style="width: 20%">
                        <a href="images/gallery/2.jpg" class="overlay" ><i class="fa fa-arrows-alt"></i></a>
                        <img src="images/gallery/2.jpg" alt="">
                    </div>
                    <div class="entry" style="width: 40%">
                        <a href="images/gallery/4.jpg" class="overlay" ><i class="fa fa-arrows-alt"></i></a>
                        <img src="images/gallery/4.jpg" alt="">
                    </div>
                    <div class="entry" style="width: 20%">
                        <a href="images/gallery/3.jpg" class="overlay" ><i class="fa fa-arrows-alt"></i></a>
                        <img src="images/gallery/3.jpg" alt="">
                    </div>
                    <div class="entry" style="width: 20%">
                        <a href="images/gallery/5.jpg" class="overlay" ><i class="fa fa-arrows-alt"></i></a>
                        <img src="images/gallery/5.jpg" alt="">
                    </div>
                    <div class="entry" style="width: 20%">
                        <a href="images/gallery/6.jpg" class="overlay" ><i class="fa fa-arrows-alt"></i></a>
                        <img src="images/gallery/6.jpg" alt="">
                    </div>
                    <div class="entry" style="width: 20%">
                        <a href="images/gallery/7.jpg" class="overlay" ><i class="fa fa-arrows-alt"></i></a>
