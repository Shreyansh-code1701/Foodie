            ...
            <div class="entry-media">
                ...
                <div class="entry-action">
                    <div class="entry-action-inner">
                        ...
                        if ($_SESSION[user] == "") {
                            ?>
                                <p style=" color: #fff; font-size: 13px;cursor: pointer;"> <i class="fa fa-heart-o animated flash" style="color:#fff; font-size: 20px;"></i>&nbsp;Like</p>
                                <?php
                            } else {
                                if ($f == 2) {
                                    ?>
...
?>
                            ...
                            <div class="col-md-4 col-xs-12 col-sm-12 cartpro " >
