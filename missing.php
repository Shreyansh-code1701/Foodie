...
?>
        ...
        <div class="col-md-12">
            <div class="col-md-7 ht-widget hw-popular-categories">
                ...
                <i class="fas fa-hand-o-right"></i>&nbsp;&nbsp;<font>Contact people with the best restaurants around them.</font><br><br>
                <div class="row">
                    ...
                    <div class="col-md-12 input-group" style="margin-bottom: 3%;">
                        ...
                        <div class="input-group-addon" style="background:#f8a631;"><i class="fas fa-user"></i></div>
                    </div>
                    <div class="col-md-12 input-group" style="margin-bottom: 3%;">
                        <input type="email" name="email" placeholder="Email" style="padding: 20px;" required="" class="form-control" />
                        <div class="input-group-addon" style="background:#f8a631;"><i class="fas fa-envelope"></i></div>
                    </div>
                    <div class="col-md-12 input-group" style="margin-bottom: 3%;">
                        <input type="text" name="subject" placeholder="subject" style="padding: 20px;" required="" pattern='^[a-zA-Z ]+$' class="form-control" />
                        <div class="input-group-addon " style="background:#f8a631;"><i class="fas fa-phone"></i></div>
                    </div>
                    <div class="col-md-12 input-group" style="margin-bottom: 3%;">
                        <textarea class="form-control" rows="5" name="sms" placeholder="Message" required=""></textarea>
                        <div class="input-group-addon" style="background:#f8a631;"><i class="fas fa-pencil"></i></div>
                    </div>
                    <div class="co-md-12 text-center">
                        <button type="submit" name="sendcontact" class="btn sendbtn">Submit</button>
            ...
            <div class=" col-md-offset-1 col-md-4 ht-widget hw-popular-categories">
                ...
                <ul style="display: inline;">
                    <li style="list-style: none; margin-top: 12%;"> <i class="fa fa-map-marker" style="color: #f8a631; font-size: 16px; "></i><?php echo $consell[8]; ?></font>
                    </li>
                    <li style="list-style: none; margin-top: 7%;"><i class="fa fa-mobile-phone" style="color: #f8a631; font-size: 16px; "></i>&nbsp;&nbsp;&nbsp;<font><?php echo $consell[11]; ?></font>
                    </li>
                    <li style="list-style: none; margin-top: 7%;"><i class="fa fa-envelope" style="color: #f8a631; font-size: 16px; "></i>&nbsp;&nbsp;&nbsp;<font><?php echo $consell[10]; ?></font>
                    </li>
                    <li style="list-style: none; margin-top: 7%;"><i class="fa fa-facebook" style="color: #f8a631; font-size: 16px; "></i>&nbsp;&nbsp;&nbsp;<font><?php echo $consell[12]; ?>/Facebook</font>
                    </li>
                    <li style="list-style: none; margin-top: 7%;"><i class="fa fa-twitter" style="color: #f8a631; font-size: 16px; "></i>&nbsp;&nbsp;&nbsp;<font><?php echo $consell[12]; ?>/Twitter</font>
                    </li>
                    <li style="list-style: none; margin-top: 7%;"><i class="fa fa-google-plus" style="color: #f8a631; font-size: 16px; "></i>&nbsp;&nbsp;&nbsp;<font><?php echo $consell[12]; ?>/Google</font>
                    </li>
                    <li style="list-style: none; margin-top: 7%;"><i class="fa fa-instagram" style="color: #f8a631; font-size: 16px; "></i>&nbsp;&nbsp;&nbsp;<font><?php echo $consell[12]; ?>/Instagram</font>
                    </li>
...
?>
    ...
    ?>
        ...
        for ($i = 1; $i <= 5; $i++) {
            if ($i <= $haa[0]) {
        ?>
                <i style="color:#f8a631;cursor: pointer;" class="fas fa-star srate" onclick="grate('rate','<?php echo $i; ?>');avgrate('sratedekho');"></i>
            <?php
            } else {
            ?>

                <i style="color:#f8a631;cursor: pointer;" class="far fa-star-o srate" onclick="grate('rate','<?php echo $i; ?>');avgrate('sratedekho');"></i>
            <?php
            }
            ?>
    <?php
...
?>
    ...
    ?>
        ...
        for ($i = 1; $i <= 5; $i++) {
            if ($i <= $haa[0]) {
        ?>
                <i style="color:#f8a631;cursor: pointer;" class="fas fa-star srate" onclick="prate('productrate',<?php echo $i; ?>);avgrate('pratedekho');"></i>
            <?php
            } else {
            ?>
                <i style="color:#f8a631;cursor: pointer;" class="far fa-star srate" onclick="prate('productrate',<?php echo $i; ?>);avgrate('pratedekho');"></i>
            <?php
            }
            ?>
