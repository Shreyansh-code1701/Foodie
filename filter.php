                ...
                <div class="container">
                    <div class="col-md-9">
                        ...
                        <div class="detailihead" style="float: left;">
                            <i class="fa fa-th" id="list" title="View" onchange="misssearch('misssearch',this.value,'list');"></i>
                                        ...
                                        <table class="table table-responsive filter" style="text-transform: capitalize;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="border:none;">
                                                    <input type="checkbox" onchange="misssearch('misssearch',0,'list');" name="price[]" value=" between 0 and 50" />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border:none;">
                                                    <input type="checkbox" onchange="misssearch('misssearch',0,'list');" name="price[]" value=" between 50 and 100" />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border:none;">
                                                    <input type="checkbox" onchange="misssearch('misssearch',0,'list');" name="price[]" value=" between 100 and 150" />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border:none;">
                                                    <input type="checkbox" onchange="misssearch('misssearch',0,'list');" name="price[]" value=" between 150 and 200" />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border:none;">
                                                    <input type="checkbox" onchange="misssearch('misssearch',0,'list');" name="price[]" value=" between 200 and 250" />
                                                </td>
                                                <td style="width:90%;border: none;">
                                                    200 - 250
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border:none;">
                                                    <input type="checkbox" onchange="misssearch('misssearch',0,'list');" name="price[]" value=" between 250 and 1000" />
                                                </td>
                                        ...
                                        <table class="table table-responsive" style="text-transform: capitalize;">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border:none;">
                                                        <input type="checkbox" onchange="misssearch('misssearch',0,'list');" value="<?php echo $mcc[0]; ?>" name="main[]" />
                                                    </td>
                                        ...
                                        <table class="table table-responsive" style="text-transform: capitalize;">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border:none;">
                                                        <input type="checkbox" onchange="misssearch('misssearch',0,'list');" value="<?php echo $stt[3]; ?>" name="store[]" />
                                                    </td>
                                    ...
                                    <div class="col-md-12 body">
                                        ...
                                        <table class="table table-responsive" style="text-transform: capitalize;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="border:none;">
                                                    <input type="checkbox" onchange="misssearch('misssearch',0,'list');" value="veg" name="type[]" />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border:none;">
                                                    <input type="checkbox" onchange="misssearch('misssearch',0,'list');" value="non veg" name="type[]" />
                                                </td>
