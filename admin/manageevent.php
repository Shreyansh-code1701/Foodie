                                ...
                                <form action="" method="post" name="eventform" class="form-group">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="event" required="" pattern="^[a-z A-Z]+$" placeholder="Enter Event"/>
                                        ...
                                        <form action="" method="post" name="searchevent">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="search" placeholder="Search Highlight Name" id="find" class="form-control" onkeyup="display('event','display','1','10');"/>
                                                    <div class="input-group-addon">
