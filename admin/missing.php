    ...
    <table class="table table-responsive table-hover mytable">
        ...
        ?>
                <tr>
                    ...
                    <td><i class="fas fa-check-circle" style=" cursor: pointer;" onClick="update('state','update','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>')"></i></td>
            ...
            ?>
                <tr>
                    ...
                    <td><i class="fas fa-edit" style="cursor:pointer;" onclick="up('state','up','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>')"></i></td>
                    <td onclick="del('state','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>');recycle('state','display','1','10');"><i class="fas fa-trash-alt"></i></td>
    ...
    <table class="table table-responsive table-hover mytable">
        ...
        ?>
                <tr>
                    ...
                    <td><i class="fas fa-check-circle" style=" cursor: pointer;" onclick="update('city','update','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[1]; ?>')"></i></td>
            ...
            ?>
                <tr >
                    ...
                    <td><i class="fas fa-edit" style="cursor:pointer;" onclick="up('city','up','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[1]; ?>')"></i></td>
                    <td onclick="del('city','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[1]; ?>');recycle('city','display','1','10');"><i class="fas fa-trash-alt"></i></td>
                </tr>
        <?php
            }
        }
    ...
    <table class="table table-responsive table-hover mytable">
        ...
        ?>
                <tr>
                    <td><?php echo $c; ?></td>
                    <td><input type="text" value="<?php echo $row[2]; ?>" id="val" class="form-control" /></td>
                    <td><i class="fas fa-check-circle" style=" cursor:pointer;" onclick="update('area','update','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[1]; ?>')"></i></td>
            ...
            ?>
                <tr>
                    <td><?php echo $c; ?></td>
                    <td><?php echo $row[2]; ?></td>
                    <td><i class="fas fa-edit" style=" cursor:pointer;" onclick="up('area','up','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[1]; ?>')"></i></td>
                    <td onclick="del('area','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[1]; ?>');recycle('area','display','1','10');"><i class="fas fa-trash-alt"></i></td>
                </tr>
        <?php
            }
        }
    ...
    <table class="table table-responsive table-hover mytable">
        ...
        ?>
                <tr>
                    <td><?php echo $c; ?></td>
                    <td><input type="text" value="<?php echo $row[1]; ?>" id="val" class="form-control" /></td>
                    <td><i class="fas fa-check-circle" style="cursor:pointer " onclick="update('maincategory','update','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>')"></i></td>
            ...
            ?>
                <tr>
                    <td><?php echo $c; ?></td>
                    <td><?php echo $row[1]; ?></td>
                    <td><i class="fas fa-edit" onclick="up('maincategory','up','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>')"></i></td>
                    <td onclick="del('maincategory','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>');recycle('maincategory','display','1','10');"><i class="fas fa-trash-alt"></i></td>
                ...
                <tr>
                    <td colspan="4">
                        <ul class="pageing">
                            ...
                            if ($_REQUEST[page] > 4) {
                            ?>
                                <li title="<?php echo $s - 1; ?>" onclick="dis('data','duration','<?php echo $s - 1; ?>','all','pachhal',0,0);">
                                    << /li>
                                        <?php
                                    }
                                    for ($i = $s; $i <= $e; $i++) {
            ...
            <tr>
                <td colspan="4">
                    <ul class="pageing">
                        ...
                        if ($_REQUEST[page] > 4) {
                        ?>
                            <li title="<?php echo $s - 1; ?>" onclick="recdis('recdata','duration','<?php echo $s - 1; ?>','all','pachhal',0,0,0);">
                                << /li>
                                    <?php
                                }
                                for ($i = $s; $i <= $e; $i++) {
    ...
    <table class="table table-responsive table-hover mytable">
        ...
        ?>
                <tr>
                    <td><?php echo $c; ?></td>
                    <td><input type="text" value="<?php echo $row[1]; ?>" id="val" class="form-control" /></td>
                    <td><i class="fas fa-check-circle" onclick="update('storetype','update','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>')"></i></td>
            ...
            ?>
                <tr>
                    <td><?php echo $c; ?></td>
                    <td><?php echo $row[1]; ?></td>
                    <td><i class="fas fa-edit" onclick="up('storetype','up','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>')"></i></td>
                    <td onclick="del('storetype','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>');recycle('storetype','display','1','10');"><i class="fas fa-trash-alt"></i></td>
...
?>
    <table class="table table-responsive table-hover mytable">
        ...
        $c = $st;
        if ($_REQUEST[find] == "") {
            $get = mysql_query("select * from subscriber  order by email asc limit $st,$pp");
        } else {
        ...
        ?>
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $c; ?></td>
                    <td><?php echo $row[1]; ?></td>
                    <td style="cursor: pointer;" onclick="del('subscriber','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>');recycle('subscriber','display','1','10');"><i class="fas fa-trash-alt"></i></td>
...
?>
    <table class="table table-responsive table-hover mytable">
        ...
        $c = $st;
        if ($_REQUEST[find] == "") {
            $get = mysql_query("select * from contactus  order by contactid desc limit $st,$pp");
        } else {
        ...
        ?>
                <tr>
                    <td><?php echo $c; ?></td>
                    <td><input type="text" value="<?php echo $row[1]; ?>" id="val" class="form-control" /></td>
                    <td><i class="fas fa-check-circle" style=" cursor:pointer;" onclick="update('contactus','update','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>')"></i></td>
            ...
            ?>
                <tr>
                    ...
                    <td onclick="del('contactus','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>');recycle('contactus','display','1','10');"><i class="fas fa-trash-alt"></i></td>
...
?>
    <table class="table table-responsive table-hover mytable">
        ...
        $c = $st;
        if ($_REQUEST[find] == "") {
            $get = mysql_query("select * from feedback  order by feedbackid desc limit $st,$pp");
        } else {
        ...
        ?>
            ...
            ?>
                <tr>
                    ...
                    <td onclick="del('feedback','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>');recycle('feedback','display','1','10');"><i class="fas fa-trash-alt"></i></td>
                ...
                <tr>
                    <td colspan="4">
                        <ul class="pageing">
                            ...
                            if ($_REQUEST[page] > 4) {
                            ?>
                                <li title="<?php echo $s - 1; ?>" onclick="dis('data','timeperiod','<?php echo $s - 1; ?>','all','pachhal',0,0);">
                                    << /li>
                                        <?php
                                    }
                                    for ($i = $s; $i <= $e; $i++) {
            ...
            <tr>
                <td colspan="4">
                    <ul class="pageing">
                        ...
                        if ($_REQUEST[page] > 4) {
                        ?>
                            <li title="<?php echo $s - 1; ?>" onclick="recdis('recdata','timeperiod','<?php echo $s - 1; ?>','all','pachhal',0,0,0);">
                                << /li>
                                    <?php
                                }
                                for ($i = $s; $i <= $e; $i++) {
...
?>
    <table class="table table-responsive table-hover mytable">
        ...
        if ($_REQUEST[find] == "") {
            ...
            $get = mysql_query("SELECT u . * , st.statename, c.cityname, a.areaname
        FROM user u, state st, city c, area a
        WHERE st.statename = u.`state`
        AND c.cityname = u.`city`
        AND a.areaname = u.`area`
        AND TYPE =2
          limit $st,$pp");
        } else {
    ...
    <table class="table table-responsive table-hover mytable">
        ...
        ?>
                <tr>
                    ...
                    <td><input type="text" value="<?php echo $row[2]; ?>" id="val" class="form-control" /></td>
                    <td></td>
                    <td><i class="fas fa-check-circle" style="cursor:pointer;" onclick="update('paymethod','update','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>')"></i></td>
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $row[1]; ?></td>
                    <td>
                        <div><i class="<?php echo $row[2]; ?>" style="font-size:16px; "></i></div>
                    </td>
                    <td><i class="fas fa-edit" style="cursor:pointer;" onclick="up('paymethod','up','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>')"></i></td>
                    <td onclick="del('paymethod','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>');recycle('paymethod','display','1','10');"><i class="fas fa-trash-alt"></i></td>
        ...
        <table class="table table-responsive table-hover mytable">
            ...
            ?>
                <tr>
                    ...
                    <td onclick="dis('data','addbanner',1,'all','vachhe','<?php echo $row[2]; ?>',0);recdis('recdata','addbanner',1,'all','vachhe',0,0,0);"><i class="fas fa-trash-alt"></i></td>
                </tr>
                ...
                <tr>
                    <td colspan="8">
                        <ul class="pageing">
                            ...
                            if ($_REQUEST[page] > 4) {
                            ?>
                                <li title="<?php echo $s - 1; ?>" onclick="dis('data','addbanner','<?php echo $s - 1; ?>','all','pachhal',0,0);">
                                    << /li>
                                        <?php
                                    }
                                    for ($i = $s; $i <= $e; $i++) {
...
?>
        <table class="table table-responsive" style="background:url(../seller/images/food.png) no-repeat 50% 50%;">
            ...
            <tr>
                <td style="width:40%;" colspan="2"><img src="../admin/images/about.png" width="40%" /></td>
                <td colspan="1">
                    <h2 style="color:#65CEA7;">FOOD LOCKER</h2>
                </td>
...
?>
    <table class="table table-responsive table-hover mytable">
        ...
        ?>
                <tr>
                    <td><?php echo $c; ?></td>
                    <td><input type="text" value="<?php echo $row[1]; ?>" required="" pattern='^[a-zA-z0-9]+$/*' id="val" class="form-control" /></td>
                    <td><i class="fas fa-check-circle" style="cursor: pointer;" onclick="update('highlight','update','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>')"></i></td>
            ...
            ?>
                <tr>
                    <td><?php echo $c; ?></td>
                    <td><?php echo $row[1]; ?></td>
                    <td><i class="fas fa-edit" style="cursor:pointer;" onclick="up('highlight','up','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>')"></i></td>
                    <td ondblclick="del('highlight','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>');recycle('highlight','display','1','10');"><i class="fas fa-trash-alt"></i></td>
...
?>
    <table class="table table-responsive table-hover mytable">
        ...
        $c = $st;
        if ($_REQUEST[find] == "") {
            $get = mysql_query("select u.username,r.* from user u,reviewstore r where u.userid=r.userid order by reviewdatetime desc limit $st,$pp");
        } else {
        ...
        ?>
            ...
            ?>
                <tr>
                    ...
                    <td onclick="del('sreview','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[3]; ?>');recycle('sreview','display','1','10');"><i class="fas fa-trash-alt"></i></td>
...
?>
    <table class="table table-responsive table-hover mytable">
        ...
        $c = $st;
        if ($_REQUEST[find] == "") {
            $get = mysql_query("select u.username,r.* from user u,reviewproduct r where u.userid=r.userid order by datetime desc limit $st,$pp");
        } else {
        ...
        ?>
            ...
            ?>
                <tr>
                    ...
                    <td onclick="del('preview','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[3]; ?>');recycle('preview','display','1','10');"><i class="fas fa-trash-alt"></i></td>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="  col-md-6" style="padding-top: 10px">
                                ...
                                <font><?php echo $q; ?></font>
                            </div>
                            <div class="  col-md-6" style="padding-top: 10px">
                                <strong> Payable Amount : </strong>
                                <font><?php echo $pb; ?></font>
                            </div>
                        </div>
