                                ...
                                <ul class="nav nav-tabs pull-right">
                                    <li class="active">
                                        <a href="#home-3" data-toggle="tab">
                                            <i class="fas fa-laptop" ondblclick="fdel('seller','delete','<?php echo $p; ?>','<?php echo $pp; ?>','<?php echo $row[0]; ?>');recycle('seller','display','1','10');"></i>
                                            DISPLAY
                                        </a>
                                    </li>
                                        ...
                                        <form action="" method="post" name="searchuser">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="search" placeholder="Search User Name" id="find" class="form-control" onkeyup="display('seller','display','1','10');"/>
                                                    <div class="input-group-addon">
