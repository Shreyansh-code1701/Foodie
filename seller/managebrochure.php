                            ...
                            <ul class="nav nav-tabs pull-right">
                                <li class="active">
                                    <a href="#home-3" data-toggle="tab">
                                        <i class="fas fa-laptop" ondblclick="dis('data','brochure',1,'all','vachhe',0,'badhurec');recdis('recdata','brochure',1,'all','vachhe',0,0,0);"></i>
                                        DISPLAY
                                    </a>
                                </li>
                                <li class="">
                                    <a href="#about-3" data-toggle="tab">
                                        <i class="fas fa-recycle" ondblclick="recdis('recdata','brochure',1,'all','vachhe',0,0,'badhu');"></i>
                                        RECYCLE
                                    </a>
                                </li>
