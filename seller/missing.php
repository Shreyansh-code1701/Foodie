        ...
        ?>
            ...
            <div class="form-group">
                <div class="input-group">        
                    ...
                    <input type="file" name="upproductpic" value = "<?php echo $du[7]; ?>" class="form-control" required="" accept=".png, .jpg, .jpeg"/>
                </div>
                <?php
                   if($er2==1)
                   {
...
<table class="table table-responsive"  >
    ...
    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" >[Cashier]Sign : <div style="position: absolute; "><img src="images/signature.png" width="50%" class="img-responsive" /></div></td>
                                            <td>
                                                <table class="table table-responsive">
